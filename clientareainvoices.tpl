  ...
  <table class="table table-striped">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>{$invoice.total}</td>
        <td><span class="label label-{if $invoice.rawstatus == 'cancelled'}info{elseif $invoice.rawstatus == 'unpaid'}warning{elseif $invoice.rawstatus == 'overdue'}danger{elseif $invoice.rawstatus == 'paid'}success{/if}">{$invoice.statustext}</span></td>
