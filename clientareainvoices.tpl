  ...
  <table class="table table-striped">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>{$invoice.total}</td>
        <td><span class="label label-{if $invoice.rawstatus == 'unpaid'}warning{elseif $invoice.rawstatus == 'overdue'}danger{elseif $invoice.rawstatus == 'paid'}success{else}default{/if}">{$invoice.statustext}</span></td>
